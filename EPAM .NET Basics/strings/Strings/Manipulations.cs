...
namespace Strings
{
    public static class Manipulations
    {
        ...
        public static string GetGreeting1(string greeting, string name)
        {
            ...
            return template.Insert(2, name.ToUpperInvariant()).Insert(0, greeting);
        }
        ...
        {
            const string template = ", !";
            return template.Insert(2, name.Trim().ToLowerInvariant()).Insert(0, greeting.Trim());
        }
        ...
        {
            return template.Replace("{name}", name.ToUpperInvariant(), StringComparison.InvariantCulture)
                .Replace("{greeting}", greeting.ToLowerInvariant(), StringComparison.InvariantCulture);
        }
