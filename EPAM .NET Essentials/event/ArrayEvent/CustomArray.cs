    ...
    public class CustomArray<T> : IEnumerable<T>
    {
        ...
        public T this[int item]
        {
            ...
            set
            {
                ...
                T oldValue = array[item - firstIndex];
                if (!Equals(oldValue, value))
                {
                    array[item - firstIndex] = value;
                    OnChangeElement?.Invoke(this, new ArrayEventArgs<T>(item, "Element value changed", value));
                }

                if (Equals(item, value))
                {
                    OnChangeEqualElement?.Invoke(this, new ArrayEventArgs<T>(item, "Element value equal to index", value));
                }
            }
        }
