...
{
    [TestFixture]
    public class SupermarketTests : ModelTestBase<Supermarket>
    {
        [Test]
        ...
        [TestCase("supermarkets")]
        public void HasTableAttribute(string tableName)
        {
            this.AssertThatHasTableAttribute(tableName);
        }

        [TestCase("Id", typeof(int), "supermarket_id")]
        [TestCase("Name", typeof(string), "supermarket_name")]
        [TestCase("Locations", typeof(IList<SupermarketLocation>), null)]
