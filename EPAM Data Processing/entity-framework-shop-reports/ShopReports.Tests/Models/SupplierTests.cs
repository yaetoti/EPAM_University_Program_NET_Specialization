...
{
    [TestFixture]
    public class SupplierTests : ModelTestBase<Supplier>
    {
        [Test]
        ...
        [TestCase("product_suppliers")]
        public void HasTableAttribute(string tableName)
        {
            this.AssertThatHasTableAttribute(tableName);
        }

        [TestCase("Id", typeof(int), "supplier_id")]
        [TestCase("Name", typeof(string), "supplier_name")]
