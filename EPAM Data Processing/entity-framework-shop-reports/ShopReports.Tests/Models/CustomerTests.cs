...
{
    [TestFixture]
    public class CustomerTests : ModelTestBase<Customer>
    {
        [Test]
        ...
        [TestCase("Id", typeof(int), "customer_id")]
        [TestCase("CardNumber", typeof(string), "card_number")]
        [TestCase("Discount", typeof(decimal), "discount")]
