...
{
    [TestFixture]
    public class ContactTypeTests : ModelTestBase<ContactType>
    {
        [Test]
        ...
        [TestCase("contact_types")]
        public void HasTableAttribute(string tableName)
        {
            this.AssertThatHasTableAttribute(tableName);
        }

        [TestCase("Id", typeof(int), "contact_type_id")]
        [TestCase("Name", typeof(string), "contact_type_name")]
